	...
	for (UIView *subview in self.subviews){
		...
		if ([subview isMemberOfClass:[UILabel class]]) { 
			...
			if (label.text == self.title) {
                label.textColor = [UIColor colorWithRed:255.0f/255.0f green:0.0f/255.0f blue:0.0f/255.0f alpha:1.0f];
                label.font = [UIFont fontWithName:@"emulogic" size:14];
            } else {
                label.font = [UIFont fontWithName:@"emulogic" size:10];
            }
...
- (void)drawRect:(CGRect)rect
{
	...
	CGContextSetFillColorWithColor(context, [UIColor colorWithRed:0.0f/255.0f green:0.0f/255.0f blue:0.0f/255.0f alpha:1.0f].CGColor);
	...
	//////////////HATCHED BACKGROUND
    CGFloat buttonOffset = 75.5f; //Offset buttonOffset by half point for crisp lines
